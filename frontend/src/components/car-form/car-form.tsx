...
const CarForm: FC<CarFormProps> = ({
    ...
    const handleChanges = (event: ChangeEvent<HTMLInputElement>) => {
        switch (event.target.name) {
            case "Chassis Number":
                changeCarValues({...newCar, chassisNumber: +event.target.value});
                break;
            case "Mileage":
                changeCarValues({...newCar, mileage: +event.target.value});
                break;
            case "Price":
                changeCarValues({...newCar, price: +event.target.value});
                break;
            case "License Plate":
                changeCarValues({...newCar, licensePlate: event.target.value});
                break;
            case "Brand":
                changeCarValues({...newCar, brand: event.target.value});
                break;
            case "Car Type":
                changeCarValues({...newCar, carType: event.target.value});
                break;
            case "Colour":
                changeCarValues({...newCar, colour: event.target.value});
                break;
        }
    }
